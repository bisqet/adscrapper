const config = {
	yad2ResultsURL : [
		...
		"http://www.yad2.co.il/Nadlan/rent.php?multiSearch=1&AreaID=&arrArea=&arrCity=1970&Neighborhood=%F9%E9%EB%E5%EF+%F6%F0%E7%F0%E9%ED&arrHomeTypeID=5%2C32%2C55&fromRooms=4&untilRooms=&fromPrice=1000&untilPrice=9000&PriceType=1&FromFloor=&ToFloor=&fromSquareMeter=90&untilSquareMeter=&EnterDate=&Info=",
		"http://www.yad2.co.il/Nadlan/rent.php?multiSearch=1&AreaID=&arrArea=&arrCity=487%2C1962&arrHomeTypeID=5%2C32%2C55&fromRooms=4&untilRooms=&fromPrice=1000&untilPrice=9000&PriceType=1&FromFloor=&ToFloor=&fromSquareMeter=120&untilSquareMeter=&EnterDate=&Info=",
...
config.sqrFilter = "sqr>150&&sqr<200"//&& - and; || - or; ! - not; >= - more or equal
config.cityFilter = {
	acceptable:['גנות'],
	disacceptable:['רמת גן'],
	mode:1
